defmodule BoomLooper.SagaCoverageTest do
  @moduledoc """
  ...
  **known multi-step state-mutating operations** in the codebase, and
  ...
  @saga_required [
    {"lib/boom_looper/agent_boot.ex", "def boot("},
    {"lib/boom_looper/workspace_supervisor.ex", "defp rebuild_saga("}
  ]
  ...
  @non_saga_reasons %{
    ...
    "lib/boom_looper/workspace/destructor.ex" =>
