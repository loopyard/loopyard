defmodule BoomLooper.AgentLog.CheckpointerTest do
  use ExUnit.Case, async: false

  alias BoomLooper.AgentLog
  alias BoomLooper.AgentLog.Checkpointer
  ...
  describe "telemetry" do
    test "emits [:boom_looper, :checkpoint, :written] on successful snapshot",
         %{log_path: log_path} do
      ...
      assert_receive {:telemetry, [:boom_looper, :checkpoint, :written], measurements, metadata},
                     500
