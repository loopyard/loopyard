defmodule BoomLooper.Saga.JournalTest do
  use ExUnit.Case, async: false

  alias BoomLooper.Saga
  alias BoomLooper.Saga.Journal

  setup do
    # Isolate every test behind its own BOOMLOOPER_HOME so the journal
  ...
  describe "path/0" do
    test "resolves under BOOMLOOPER_HOME", %{tmp: tmp, path: path} do
