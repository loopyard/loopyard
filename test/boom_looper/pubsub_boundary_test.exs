defmodule BoomLooper.PubSubBoundaryTest do
  @moduledoc """
  ...
  under `lib/boom_looper/events/`. Raw `Phoenix.PubSub.broadcast` calls
  ...
  test "no raw Phoenix.PubSub.broadcast calls outside publisher modules" do
    ...
    assert violations == [],
           "Raw Phoenix.PubSub.broadcast calls are forbidden outside #{@allowed_prefix}. " <>
             "Route these through a BoomLooper.Events.* publisher module. " <>
             "Offenders:\n" <>
