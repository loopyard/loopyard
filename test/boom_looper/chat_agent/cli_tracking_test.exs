defmodule BoomLooper.ChatAgent.CliTrackingTest do
  @moduledoc """
  ...
  The fix: track the OS pid via `BoomLooper.Resources.track/4` with
  ...
  describe "track_cli_os_pid discipline" do
    ...
    test "Resources.list_for_owner returns no :claude_cli entries under fake backend",
      ...
      entries = BoomLooper.Resources.list_for_owner(pid)
