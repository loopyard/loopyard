defmodule LoopyardWeb.SystemSagasLiveTest do
  @moduledoc """
  Smoke tests for `/system/sagas`. Real saga recording is covered in
  `Loopyard.Saga.RecorderTest`; this file just verifies the LV
  ...
  alias Loopyard.{Saga, Saga.Journal, Saga.Recorder}

  setup do
    :ets.delete_all_objects(Recorder.table())

    # Journal tests write to LOOPYARD_HOME/sagas.log. Ensure clean
