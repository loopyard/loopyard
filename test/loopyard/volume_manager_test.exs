defmodule Loopyard.VolumeManagerTest do
  ...
  describe "create_volume/1" do
    ...
    test "creates a Docker volume" do
      volume_name = "loopyard-test-#{:rand.uniform(100_000)}"
  ...
  describe "glob/2" do
    ...
    test "finds files matching pattern in a volume" do
      volume_name = "loopyard-test-glob-#{:rand.uniform(100_000)}"
  ...
  describe "tree/3" do
    ...
    test "returns structured entries for volume contents" do
      volume_name = "loopyard-test-tree-#{:rand.uniform(100_000)}"
  ...
  describe "volume_ls/2" do
    ...
    test "lists directory contents in volume" do
      volume_name = "loopyard-test-ls-#{:rand.uniform(100_000)}"
    ...
    test "lists subdirectory contents" do
      volume_name = "loopyard-test-ls-sub-#{:rand.uniform(100_000)}"
