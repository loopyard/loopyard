defmodule Loopyard.ChatAgent.IdleReapTest do
  ...
  manually stops each agent or restarts Loopyard.
  ...
  setup do
    ...
    # last_activity_at.
    Application.put_env(:loopyard, :agent_idle_check_interval_ms, 100)
    Application.put_env(:loopyard, :agent_idle_reap_hours, 1)

    on_exit(fn ->
      Application.delete_env(:loopyard, :agent_idle_check_interval_ms)
      Application.delete_env(:loopyard, :agent_idle_reap_hours)
    end)
