defmodule Loopyard.ChatAgent.SessionResumeTest do
  @moduledoc """
  ...
  or a Loopyard server restart that replayed the agent log — the
  ...
  describe "server restart (init_resume)" do
    test "resumes with claude_session_id from the saved summary", %{id: id} do
      ...
      # ServiceManager does after a Loopyard server restart.
