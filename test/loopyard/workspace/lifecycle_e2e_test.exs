defmodule Loopyard.Workspace.LifecycleE2ETest do
  @moduledoc """
  ...
  test/loopyard/workspace/lifecycle_e2e_test.exs` or let CI's
  ...
  alias Loopyard.{Compose, Docker, VolumeManager, Workspace, WorkspaceSupervisor}
