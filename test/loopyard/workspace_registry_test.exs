defmodule Loopyard.WorkspaceRegistryTest do
  ...
  describe "list_workspaces/1" do
    ...
    test "main workspace sorts first" do
      WorkspaceRegistry.insert("ws-dev", %{
        id: "ws-dev",
        project_id: "p1",
        name: "dev",
        path: "/dev",
      ...
      WorkspaceRegistry.insert("ws-main", %{
        id: "ws-main",
        project_id: "p1",
        name: "main",
        path: "/main",
  ...
  describe "worktree_path normalization" do
    ...
    test "does NOT backfill for virtual workspace dirs" do
      virtual_path = Path.join([Loopyard.Workspace.home_dir(), "workspaces", "ws-virt"])
  ...
  describe "compose_dir normalization" do
    test "always points to the virtual workspace dir" do
      ...
      assert ws.compose_dir == Path.join([Loopyard.Workspace.home_dir(), "workspaces", "ws-cd"])
