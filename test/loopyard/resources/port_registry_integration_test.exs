defmodule Loopyard.Resources.PortRegistryIntegrationTest do
  @moduledoc """
  ...
  alias Loopyard.{PortRegistry, Resources}
  ...
  # Register a plain pid in Loopyard.WorkspaceRegistry under the
  ...
  defp spawn_workspace_group(ws) do
    ...
    pid =
      spawn(fn ->
        {:ok, _} = Registry.register(Loopyard.WorkspaceRegistry, ws, nil)
