defmodule Loopyard.Tools.Container.UrlToolsTest do
  ...
  describe "app_url reads from PortRegistry" do
    ...
    test "returns the registered host_port, not the Docker ephemeral port" do
      ...
      result =
        Loopyard.Tools.Container.AppUrl.execute(
  ...
  describe "URI construction" do
    ...
    test "localhost without port is NOT rewritten (Loopyard relative)" do
