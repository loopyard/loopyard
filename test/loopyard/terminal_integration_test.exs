defmodule Loopyard.TerminalIntegrationTest do
  @moduledoc """
  ...
  describe "full websocket stack" do
    ...
    test "multiple viewers via PubSub each see output once", %{container: container} do
      ...
      terminal_pid = elem(hd(Registry.lookup(Loopyard.TerminalRegistry, container)), 0)
    ...
    test "buffer replay + live output does not duplicate", %{container: container} do
      ...
      GenServer.cast(
        elem(hd(Registry.lookup(Loopyard.TerminalRegistry, container)), 0),
