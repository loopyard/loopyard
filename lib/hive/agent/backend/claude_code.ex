defmodule Hive.Agent.Backend.ClaudeCode do
  @moduledoc """
  Backend implementation wrapping the `claude_code` hex package (CLI subprocess).
  Translates SDK message types into `Hive.Agent.Event` structs.
  """
  @behaviour Hive.Agent.Backend
  ...
  # --- Translation: SDK messages → Hive events ---
