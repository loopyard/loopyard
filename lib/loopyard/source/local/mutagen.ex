defmodule Loopyard.Source.Local.Mutagen do
  @moduledoc """
  ...
  `Application.get_env(:loopyard, :mutagen_runner, &System.cmd/3)` so unit
  ...
  defp run(args) do
    runner =
      Application.get_env(:loopyard, :mutagen_runner) ||
        (&default_runner/1)
