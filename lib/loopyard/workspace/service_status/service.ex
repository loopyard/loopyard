defmodule Loopyard.Workspace.ServiceStatus.Service do
  @moduledoc """
  One service known to Loopyard. Built by `ServiceStatus.for_workspace/1`.
  ...
  Hoisted out of `Loopyard.Workspace.ServiceStatus` so the Elixir 1.19
