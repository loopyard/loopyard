defmodule BoomLooperWeb.SystemOrphansLive do
  @moduledoc """
  Lists every tracked `BoomLooper.Resources` entry, grouped by owner.
  ...
  def render(assigns) do
    ~H"""
    <.page_shell
      breadcrumbs={[{"Boom Looper", "/"}, {"System", "/system"}, {"Orphans", nil}]}
      ...
      <div class="space-y-6">
        <section>
          ...
          <p class="text-xs text-zinc-500 dark:text-zinc-400 mb-4">
            Every resource tracked via <code class="font-mono">BoomLooper.Resources.track/4</code>.
