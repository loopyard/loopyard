defmodule BoomLooperWeb.Live.WorkspaceLive.Components.SetupProgress do
  @moduledoc """
  ...
  this map in response to `BoomLooper.Events.WorkspaceSetup` events.

  Renders three phases (matching `BoomLooper.Workspace.Setup.phases/0`):
  ...
  # `format_bytes/1` is canonical in `BoomLooperWeb.Format` (auto-imported
