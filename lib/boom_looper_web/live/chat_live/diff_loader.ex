defmodule BoomLooperWeb.Live.ChatLive.DiffLoader do
  @moduledoc """
  Git diff fetches for the chat_live diff viewer.

  Pulled out of `ChatLive` so the five scattered LiveView callbacks
