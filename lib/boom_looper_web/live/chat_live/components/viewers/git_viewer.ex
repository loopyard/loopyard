defmodule BoomLooperWeb.Live.ChatLive.Components.Viewers.GitViewer do
  @moduledoc """
  ...
  alias BoomLooperWeb.Live.ChatLive.Components.Viewers.Syntax
  ...
  def diff_viewer(assigns) do
    ...
    language = if assigns.path, do: BoomLooperWeb.Live.ChatLive.Components.Viewers.FileType.language(assigns.path)
