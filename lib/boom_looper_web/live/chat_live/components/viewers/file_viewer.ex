defmodule BoomLooperWeb.Live.ChatLive.Components.Viewers.FileViewer do
  @moduledoc """
  ...
  alias BoomLooperWeb.Live.ChatLive.Components.Viewers.{FileType, TextViewer, ImageViewer, BinaryViewer}
  ...
  def file_viewer(assigns) do
    ...
    ~H"""
    <TextViewer.text_viewer :if={@file_type == :text} path={@path} content={@content} />
