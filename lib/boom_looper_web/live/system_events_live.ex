defmodule BoomLooperWeb.SystemEventsLive do
  @moduledoc """
  Live timeline of every BoomLooper PubSub broadcast on the global
  topics tracked by `BoomLooper.Events.Tap`. Drop this URL into any
