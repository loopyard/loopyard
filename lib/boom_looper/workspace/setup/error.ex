defmodule BoomLooper.Workspace.Setup.Error do
  @moduledoc """
  Classifies raw saga step errors into structured error maps that the UI
  can render and `BoomLooper.Retry` can use to decide whether to retry.
  ...
  `BoomLooper.Retry.run/2` so the retry classifier and the UI classifier
