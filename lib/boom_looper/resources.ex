defmodule BoomLooper.Resources do
  @moduledoc """
  ...
  resource. A supervised janitor (`BoomLooper.Resources.Janitor`)
  ...
  ## API shape
      ...
      BoomLooper.Resources.track(
        ...
        fn -> BoomLooper.PortRegistry.release(ws, svc, cport) end
      )
