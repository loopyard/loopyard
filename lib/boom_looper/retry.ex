defmodule BoomLooper.Retry do
  ...
  ## Examples
      ...
      iex> BoomLooper.Retry.backoff_ms(1, {:custom, [100, 300, 900]})
      100
      iex> BoomLooper.Retry.backoff_ms(2, {:custom, [100, 300, 900]})
      300
      iex> BoomLooper.Retry.backoff_ms(9, {:custom, [100, 300, 900]})
      900

      iex> BoomLooper.Retry.backoff_ms(1, {:exponential, 2_000})
      2_000
      iex> BoomLooper.Retry.backoff_ms(3, {:exponential, 2_000})
      8_000

      iex> BoomLooper.Retry.backoff_ms(5, {:fixed, 500})
      500
  """
