defmodule BoomLooper.Events.SourceSync do
  @moduledoc """
  Publisher module for the per-workspace `"source_sync:{workspace_id}"`
  PubSub topic. `BoomLooper.Source.Local.SyncMonitor` publishes here when
...
defmodule BoomLooper.Events.SourceSync.Subscriber do
  @moduledoc """
  Behaviour for LiveViews that subscribe to a workspace's sync topic.
  """

  alias BoomLooper.Events.SourceSync
