defmodule LoopyardWeb.Components.Dashboard do
  ...
  def dashboard_card(assigns) do
    ...
    <.link
      navigate={@navigate}
      class="group flex flex-col rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-brand-paper dark:bg-brand-ink/40 p-5 hover:border-indigo-300 dark:hover:border-indigo-500/40 hover:bg-zinc-50/60 dark:hover:bg-zinc-800/30 transition-colors"
    >
