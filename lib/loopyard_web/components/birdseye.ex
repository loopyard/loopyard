defmodule LoopyardWeb.Components.Birdseye do
  ...
  def port_chip(assigns) do
    ...
    <a
      ...
      target="_blank"
      rel="noopener"
      class="group/port tap-target inline-flex items-center gap-1 rounded-sm px-1.5 py-0.5 text-meta font-mono text-emerald-600/90 dark:text-emerald-400/90 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors"
