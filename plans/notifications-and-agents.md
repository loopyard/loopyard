...
Status (Sep 2, 2026): Track A shipped; Batch 1 of the agents work (templates, one spawn path, system agents, `/agents`, the Agents card, the three-root nav) shipped to main (#112, #106, #110, #107, #113 closed). Batch 2 (the Loop rename + `Loop.Direct`) next.
